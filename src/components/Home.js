        ...
        return (
            <div className="Home">
                ...
                <p>«Прокат Вена» предлагает услуги по прокату автомобилей в Вене и по Австрии за самые низкие цены.
                    ...
                    сайтов
                    наших конкурентов и убедиться в этом.</p>
                <p>
                    ...
                    мы предоставляем машины без
                    ограничения пробега и количества водителей.
                </p>
                <p>

                    Не смотря на лучшие цены, наш прокат машин в Вене (Австрии) предоставляет только высококачественные
                    услуги.
                    Выбирая наши авто, Вы можете быть уверены в их надежности, т.к. каждый автомобиль проходит
                    ...
                    а
                    потому
                    90% наших машин не старше 2 лет (из них половина до года). Наибольший возраст авто 3 года.
                </p>
                ...
                <p>
                    ...
                    можно <b>без
                    банковской карты</b> и без предоплат за резервацию авто.
                </p>
